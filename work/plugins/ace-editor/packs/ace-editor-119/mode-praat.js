...
var PraatHighlightRules = function() {
    ...
    var functions = (
        ...
        "beginPause|endPause|" +
        "ymit-pluginShow|ymit-pluginWindowTitle|ymit-pluginInput|ymit-pluginWaitForInput|" +
        "ymit-pluginClicked|ymit-pluginClickedIn|ymit-pluginX|ymit-pluginY|" +
        "ymit-pluginKeyPressed|ymit-pluginKey\\$|" +
        "ymit-pluginExtraControlKeyPressed|ymit-pluginShiftKeyPressed|"+
        "ymit-pluginCommandKeyPressed|ymit-pluginOptionKeyPressed|" +
        ...
        "start" : [
            {
                ...
                regex : /(^\s*)(?:(ymit-plugin)?(\s+))((?:[A-Z][^.:"]+)(?:$|(?:\.{3}|:)))/
            }, {
                token : ["text", "keyword", "text", "keyword"],
                regex : /^(\s*)(?:(ymit-plugin)(\s+))?(10|12|14|16|24)$/
            }, {
